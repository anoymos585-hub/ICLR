...
import numpy as np
import random
from utils import cot_prompt, kl_scoring, simi_scoring, cot_prompt_only_correct, cot_prompt_OOD
...
prompt_structure = """
Here is the question to the answer:
<question>
{question}
</question>
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='../data/okvqa_dataset.json')
    parser.add_argument('--token_use', type=str, default="topk")
    parser.add_argument('--mask_ratio', type=int, default=25)
    ...
    for each in check_dataset2:
        check_dataset.append("../"+each["image_path"])
    prompts, answers, images = cot_prompt_OOD(dataset, check_dataset)
    ...
    data = [args.function_name, args.model_name, args.use_head, args.mask_ratio, head_score, acc_num / len(prompts), args.token_use]
