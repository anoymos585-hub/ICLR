...
2. If you are unclear about whether the two answers are similar, you might also check the original question, such as the options or some information in the original question.
    ...
    for i in range(len(dataset)):
        ...
        for j in range(len(generated)):
            ...
            prompt_text = gpt_prompt.format(
                question=generated[j]['subquestion'],
...
def main(): 
    ...
    with open("head_results/output_" + args.model_name + "_" + dataset_name + "_" + args.mode + ".json", "r", encoding="utf-8") as file:
    ...
    all_prompts, all_images = cot_prompt(dataset, llm_answer, args)


    #input_filename = "./gpt_io/input_answer_gpt_" + args.llm_model_method + args.model_name + "_" + dataset_name + "_" + args.mode + ".json"
    output_filename = "./gpt_io/output_answer_gpt_" + args.llm_model_method + args.model_name + "_" + dataset_name + "_" + args.mode + ".json"
    ...
    with open(f'./head_results/{args.model_name}_{dataset_name}_token_positions_{args.mode}.pkl', "rb") as f:
        meaning_token_positions_list = pickle.load(f)
    with open("./head_results/output_" + args.model_name + "_" + dataset_name + "_" + args.mode + "_with_gpt_label.json", "w") as f:
    ...
    with open(f'./head_results/{args.model_name}_{dataset_name}_topk_position_{args.mode}.pkl', "wb") as f:
